...
def create_reseller(reseller: schemas.ResellerCreate, db: Session = Depends(dependencies.get_db)):
...
def read_customers(skip: int = 0, limit: int = 10, db: Session = Depends(dependencies.get_db)):
...
def read_products(skip: int = 0, limit: int = 10, db: Session = Depends(dependencies.get_db)):
